...
window.addEventListener('DOMContentLoaded', function () {
  ...
  player.init();
  new _modules_difference__WEBPACK_IMPORTED_MODULE_2__["default"]('.officerold', '.officernew', '.officer__card-item').init();
...
function () {
  ...
  _createClass(Form, [{
    ...
    key: "checkTextInputs",
    value: function checkTextInputs() {
  ...
  _createClass(MainSlider, [{
    ...
    value: function render() {
      ...
      this.btns.forEach(function (btn) {
        ...
        var el = btn.parentNode.previousElementSibling;
